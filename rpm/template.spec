...
%global pkg_name service_load_balancing
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-service-load-balancing
Version:        0.1.3
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Barry Xu <barry.xu@sony.com> - 0.1.3-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Barry Xu <barry.xu@sony.com> - 0.1.3-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Barry Xu <barry.xu@sony.com> - 0.1.3-1
- Autogenerated by Bloom
